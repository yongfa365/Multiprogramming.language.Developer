...
namespace ConsoleApp.BestPractices
{
    ...
    public class AboutThread
    {
        public static void RunDemo()
        {
            ...
            #region 常用的线程及并行操作，Task,Parallel,这些默认都是通过ThreadPool开线程的
            {
                //启动个线程
                ...
                #region 线程同步的,相当容易，就是个Task.WaitAll，当然还有更高级的，但基本这个就够用了。
                {
            ...
            #region 早期开线程的方法，不建议研究
            {
                //new Thread开的线程的特点：
                //  1.是野线程：不受ThreadPool控制。
