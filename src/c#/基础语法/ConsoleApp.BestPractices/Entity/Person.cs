...
namespace ConsoleApp.BestPractices
{
    ...
    */
    ...
    public class Person
    {
        ...
        public decimal Height { get; set; } = 100; //默认值
        public bool IsHuman => true; //只读，总是返回true
        public bool IsHuman2 { get { return true; } } //只读，总是返回true
        public bool IsHuman3 { get; } //只读
        public bool IsHuman4 { get; private set; } //仅内部可改
        public DateTime? Now => DateTime.Now; //每次调用返回当前时间  //?表示可空
